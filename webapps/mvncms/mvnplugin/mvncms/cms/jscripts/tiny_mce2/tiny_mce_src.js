...
TinyMCE_Engine.prototype = {
	init : function(settings) {
		...
		this.settings.base_href = current_upload_path;
		if (this.isRealIE)
			this.settings.base_href = document.location.protocol + "//" + document.location.host + current_upload_path;
