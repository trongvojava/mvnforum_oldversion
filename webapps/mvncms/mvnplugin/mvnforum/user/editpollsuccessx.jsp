<%--
 - $Header: /home/cvsroot/mvnforum_enterprise/srcweb/mvnplugin/mvnforum/user/editpollsuccessx.jsp,v 1.15 2009/10/22 06:49:25 trungth Exp $
 - $Author: trungth $
 - $Revision: 1.15 $
...
<mvn:head>
  <mvn:title><fmt:message key="mvnforum.common.forum.title_name"/> - <fmt:message key="mvnforum.user.editpollsuccessx.title"/></mvn:title>
...
<%if (isPollPortlet == false) {%>
  ...
  <div class="nav center">
    ...
    <fmt:message key="mvnforum.user.editpollsuccessx.title"/>
  </div>
  <%}%>
<%} else {%>
