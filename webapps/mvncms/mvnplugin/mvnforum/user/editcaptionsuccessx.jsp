<%--
  - $Header: /home/cvsroot/mvnforum_enterprise/srcweb/mvnplugin/mvnforum/user/editcaptionsuccessx.jsp,v 1.9 2009/10/22 09:54:19 hoanglt Exp $
  - $Author: hoanglt $
  - $Revision: 1.9 $
...
<mvn:head>
  <mvn:title><fmt:message key="mvnforum.common.forum.title_name"/> - <fmt:message key="mvnforum.user.editcaptionsuccessx.title"/></mvn:title>
...
<div class="nav center">
  ...
  <% if (albumItemBean.getItemTitle().length() > 0) {%>
    ...
    <%}%>
  <fmt:message key="mvnforum.user.editcaptionsuccessx.title"/>
</div>
<br/>
