<%--
  - $Header: /home/cvsroot/mvnforum_enterprise/srcweb/mvnplugin/mvnforum/user/addopenidsuccessx.jsp,v 1.4 2009/07/16 03:28:22 xuantl Exp $
  - $Author: xuantl $
  - $Revision: 1.4 $
...
<mvn:head>
  <mvn:title><fmt:message key="mvnforum.common.forum.title_name"/> - <fmt:message key="mvnforum.user.addopenidsuccessx.title"/></mvn:title>
...
<div class="nav center">
  ...
  <fmt:message key="mvnforum.user.addopenidsuccessx.title"/>
</div>
<br/>
