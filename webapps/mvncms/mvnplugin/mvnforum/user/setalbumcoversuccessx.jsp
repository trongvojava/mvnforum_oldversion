<%--
  - $Header: /home/cvsroot/mvnforum_enterprise/srcweb/mvnplugin/mvnforum/user/setalbumcoversuccessx.jsp,v 1.12 2009/10/22 09:54:19 hoanglt Exp $
  - $Author: hoanglt $
  - $Revision: 1.12 $
...
<mvn:head>
  <mvn:title><fmt:message key="mvnforum.common.forum.title_name"/> - <fmt:message key="mvnforum.user.setalbumcoversuccessx.title"/></mvn:title>
...
<div class="nav center">
  ...
  <fmt:message key="mvnforum.common.albumitem"/>: <a href="<%=urlResolver.encodeURL(request, response, "viewalbumitem?itemid=" + bean.getAlbumItemID())%>">
    ...
    <%}%>
  <fmt:message key="mvnforum.user.setalbumcoversuccessx.title"/>
</div>
<br/>
