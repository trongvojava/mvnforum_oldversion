<%--
  - $Header: /home/cvsroot/mvnforum_enterprise/srcweb/mvnplugin/mvnforum/user/deletealbumsuccessx.jsp,v 1.10 2009/10/22 09:54:19 hoanglt Exp $
  - $Author: hoanglt $
  - $Revision: 1.10 $
...
<mvn:head>
  <mvn:title><fmt:message key="mvnforum.common.forum.title_name"/> - <fmt:message key="mvnforum.user.deletealbumsuccessx.title"/></mvn:title>
<%@ include file="/mvnplugin/mvnforum/meta.jsp"%>
<meta http-equiv="refresh" content="3; url=<%=urlResolver.encodeURL(request, response, "myalbums")%>" />
...
<div class="nav center">
  ...
  <fmt:message key="mvnforum.user.deletealbumsuccessx.title"/>
</div>
<br/>
...
<mvn:cssrows>
  ...
  <tr class="<mvn:cssrow/>">
    <td>
      <b>&raquo;&nbsp;</b>
      <a class="command" href="<%=urlResolver.encodeURL(request, response, "myalbums")%>"><fmt:message key="mvnforum.user.listalbumsx.my_albums"/></a>
