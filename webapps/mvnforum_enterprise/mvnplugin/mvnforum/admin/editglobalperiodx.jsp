<%--
  - $Header: /home/cvsroot/mvnforum_enterprise/srcweb/mvnplugin/mvnforum/admin/editglobalperiodx.jsp,v 1.11 2009/08/13 10:31:09 thonh Exp $
  - $Author: thonh $
  - $Revision: 1.11 $
...
<mvn:head>
<mvn:title><fmt:message key="mvnforum.common.forum.title_name" /> - <fmt:message key="mvnforum.admin.editglobalperiodx.title" /></mvn:title>
...
function ValidateForm() {
  ...
  <%if (bean.getVotePeriodMinValue() == 0 && bean.getVotePeriodMaxValue() == 0) {%>
    if (isBlank(document.submitform.VotePeriodMinValue, "<fmt:message key="mvnforum.common.vote_period.min_value" />")) return false;
    if (isBlank(document.submitform.VotePeriodMaxValue, "<fmt:message key="mvnforum.common.vote_period.max_value" />")) return false;
  <%}%>
...
<div class="nav center">
  ...
  <fmt:message key="mvnforum.admin.editglobalperiodx.title" />: <%=bean.getVotePeriodName()%> 
</div>
<br />

<form action="<%=urlResolver.encodeURL(request, response, "editglobalperiodprocess", URLResolverService.ACTION_URL)%>" method="post" name="submitform" onsubmit="return false;">
<%=urlResolver.generateFormAction(request, response, "editglobalperiodprocess")%>
<mvn:securitytoken />
<input type="hidden" name="md5pw" value="" />
<table class="tborder" width="95%" cellspacing="1" cellpadding="3" align="center">
<mvn:cssrows>
  <tr class="portlet-section-header">
    <td colspan="2"><fmt:message key="mvnforum.admin.editglobalperiodx.title" /></td>
  </tr>
  <tr class="<mvn:cssrow/>">
...
<%if (bean.getVotePeriodMinValue() == 0 && bean.getVotePeriodMaxValue() == 0) {%>
  <tr class="<mvn:cssrow/>">
    <td><label for="voteperiodminvalue"><fmt:message key="mvnforum.common.vote_period.min_value" /></label> <span class="requiredfield"> *</span></td>
    <td><input id="voteperiodminvalue" name="VotePeriodMinValue" type="text" size="50" value="<%=bean.getVotePeriodMinValue()%>" /></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td><label for="voteperiodmaxvalue"><fmt:message key="mvnforum.common.vote_period.max_value" /></label> <span class="requiredfield"> *</span></td>
    <td><input id="voteperiodmaxvalue" name="VotePeriodMaxValue" type="text" size="50" value="<%=bean.getVotePeriodMaxValue()%>" /></td>
  </tr>
<%}%>
  <tr class="<mvn:cssrow/>">
  ...
  <tr class="<mvn:cssrow/>">
    <td><label for="voteperiodoption"><fmt:message key="mvnforum.common.vote_period.option" /></label></td>
    <td>
