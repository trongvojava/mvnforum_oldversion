<%--
 - $Header: /home/cvsroot/mvnforum_enterprise/srcweb/mvnplugin/mvnforum/user/setpolldefaultsuccessx.jsp,v 1.2 2009/11/19 11:16:07 xuantl Exp $
 - $Author: xuantl $
 - $Revision: 1.2 $
...
<mvn:head>
  <mvn:title><fmt:message key="mvnforum.common.forum.title_name"/> - <fmt:message key="mvnforum.user.setpolldefaultsuccess.title"/></mvn:title>
...
<%if (isPollPortlet == false) {%>
  ...
  <div class="nav center">
    ...
    <fmt:message key="mvnforum.user.setpolldefaultsuccess.title"/>
  </div>
<%} else {%>
