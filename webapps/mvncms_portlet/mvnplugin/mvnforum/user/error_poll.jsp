<%--
  - $Header: /home/cvsroot/portlet-mvnforum/srcweb/mvnplugin/mvnforum/user/error_poll.jsp,v 1.4 2010/08/20 05:16:09 minhnn Exp $
  - $Author: minhnn $
  - $Revision: 1.4 $
...
<table width="240" class="left_box" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>
      <div>
        <fmt:message key="java.lang.IllegalStateException.default_poll_hasnot_been_set"/>
      </div>
