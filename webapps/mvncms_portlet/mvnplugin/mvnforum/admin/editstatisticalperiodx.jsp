<%--
  - $Header: /home/cvsroot/mvnforum_enterprise/srcweb/mvnplugin/mvnforum/admin/editstatisticalperiodx.jsp,v 1.6 2009/08/13 10:31:09 thonh Exp $
  - $Author: thonh $
  - $Revision: 1.6 $
...
<mvn:head>
<mvn:title><fmt:message key="mvnforum.common.forum.title_name" /> - <fmt:message key="mvnforum.admin.editstatisticalperiodx.title" /></mvn:title>
...
<div class="nav center">
  ...
  <fmt:message key="mvnforum.admin.editstatisticalperiodx.title" />: <%=bean.getVotePeriodName()%> 
</div>
<br />

<form action="<%=urlResolver.encodeURL(request, response, "editstatisticalperiodprocess", URLResolverService.ACTION_URL)%>" method="post" name="submitform" onsubmit="return false;">
<%=urlResolver.generateFormAction(request, response, "editstatisticalperiodprocess")%>
<mvn:securitytoken />
...
<mvn:cssrows>
  <tr class="portlet-section-header">
    <td colspan="2"><fmt:message key="mvnforum.admin.editstatisticalperiodx.title" /></td>
  </tr>
  <tr class="<mvn:cssrow/>">
  ...
  <tr class="<mvn:cssrow/>">
    ...
    <td>
      <input id="voteperiodstartdate" name="VotePeriodStartDate" id="voteperiodstartdate" type="text" size="50" value="<%=df.format(bean.getVotePeriodStartDate())%>" />
