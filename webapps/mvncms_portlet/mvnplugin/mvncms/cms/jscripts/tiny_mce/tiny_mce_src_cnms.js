/**
 * $RCSfile: tiny_mce_src_cnms.js,v $
 * $Revision: 1.1 $
 * $Date: 2006/10/21 03:24:40 $
 *
 * @author Moxiecode
...
function TinyMCE_init(settings) {
	...
	defParam("valid_elements", "a[name|href|target|title],strong/b[class],em/i[class],strike[class],u[class],p[class|align],ol,ul,li,br,map[name],img[class|src|border=0|alt|title|usemap|hspace|vspace|width|height|align],area[shape|coords|onClick|href],sub,sup,blockquote[dir|style],table[border=0|cellspacing|cellpadding|width|height|class|align],tr[class|rowspan|width|height|align|valign],td[class|colspan|rowspan|width|height|align|valign],div[class|align],span[class|align],pre[class|align],address[class|align],h1[class|align],h2[class|align],h3[class|align],h4[class|align],h5[class|align],h6[class|align],hr");
	defParam("extended_valid_elements", "onClick");
...
function TinyMCE__createIFrame(replace_element) {
	alert("replace_element " + replace_element);
...
function TinyMCE_convertStringToXML(html_data) {
    ...
    */
        if ( chr == 60 /*'<'*/ || chr == 62/*'>'*/ || chr == 38/*'&'*/ || chr == 8260/*'/'*/ || chr == 34 /* '"' */ ) {
            output += '&' + tinyMCE.cleanup_entities["c" + chr] + ';';
        } else if ( chr == 39 ) {
            output += '&apos;'; /* escape of single quote "'" */
        } else 
            output += '' + String.fromCharCode(chr);
    }
